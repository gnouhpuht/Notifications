...
public class MainActivity extends AppCompatActivity {
    ...
    public void sendNotification() {
        ...
        notifyBuilder.addAction(R.drawable.download,
    ...
    public void updateNotification() {
        ...
        Bitmap androidImage = BitmapFactory
                .decodeResource(getResources(), R.drawable.download);
...
//                .setBigContentTitle(getString(R.string.notification_updated)));
        ...
        notifyBuilder.setStyle(new NotificationCompat.InboxStyle().addLine("This section lists possible homework assignments for students who are working through this codelab as part of a course led by an instructor. It's up to the instructor to do the following:")
                        .setBigContentTitle("hdfasfadfhasdjfa")
                        .setSummaryText("dfdgadgafdhgfhare"));
        // Deliver the notification.
        mNotifyManager.notify(NOTIFICATION_ID, notifyBuilder.build());
